        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AI & ML</h3>
              <h4>Machine Learning & AI Development</h4>
              <p>
                Building intelligent systems using supervised and unsupervised learning.
                Experienced in end-to-end ML pipelines — from data preprocessing
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Analysing and visualising data to extract meaningful insights.
                Worked on real-world projects like Fake News Detection and
                Twitter Sentiment Analysis using NLP and data science techniques.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
